-- ============================================================
-- Financial Forensic RAG - PostgreSQL / pgvector Schema
...
CREATE SCHEMA IF NOT EXISTS forensic_rag;
SET search_path TO forensic_rag, public;
...
WHERE
table_schema = 'forensic_rag'
ORDER BY
table_name;
SELECT * FROM forensic_rag.v_document_ingestion_status;
SELECT * FROM forensic_rag.documents;
SELECT * FROM forensic_rag.chunks;
SELECT * FROM forensic_rag.financial_records;
SELECT
attname AS column_name,
format_type(atttypid, atttypmod) AS data_type
FROM pg_attribute
WHERE attrelid = 'forensic_rag.chunks'::regclass
